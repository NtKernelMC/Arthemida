...
1. Статическая библиотека античита написанная на заказ для проекта MTA Province by NtKernelMC при участии holmes0 
2. (Бывшего спец.администратора MTA Province)
